...
class CreateTênTiếngAnhsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Tên_tiếng_anhs", 'tên_tiếng_anhs', 'c1', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('tên_tiếng_anhs')) {
            Schema::drop('tên_tiếng_anhs');
        }
    }
}
