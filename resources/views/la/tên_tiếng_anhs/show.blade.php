...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $tên_tiếng_anh->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Tên_Tiếng_Anhs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/tên_tiếng_anhs/'.$tên_tiếng_anh->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Tên_Tiếng_Anhs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.tên_tiếng_anhs.destroy', $tên_tiếng_anh->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/tên_tiếng_anhs') }}" data-toggle="tooltip" data-placement="right" title="Back to Tên Tiếng Anhs"><i class="fa fa-chevron-left"></i></a></li>
