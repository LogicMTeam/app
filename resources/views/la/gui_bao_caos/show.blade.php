...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $gui_bao_cao->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Gui_bao_caos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/gui_bao_caos/'.$gui_bao_cao->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Gui_bao_caos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.gui_bao_caos.destroy', $gui_bao_cao->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/gui_bao_caos') }}" data-toggle="tooltip" data-placement="right" title="Back to Gui bao caos"><i class="fa fa-chevron-left"></i></a></li>
