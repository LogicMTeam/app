...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("000s", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/000s/'.$000->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("000s", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.000s.destroy', $000->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/000s') }}" data-toggle="tooltip" data-placement="right" title="Back to 000s"><i class="fa fa-chevron-left"></i></a></li>
